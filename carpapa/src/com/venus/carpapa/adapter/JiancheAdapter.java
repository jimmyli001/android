...
public class JiancheAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Spinner statusTextView;
		ImageView exceptionTextView = null;
		convertView = layoutInflater.inflate(R.layout.item_jianche, null);
		itemNameTextView = (TextView) convertView
				.findViewById(R.id.itemNameTextView);
		statusTextView = (Spinner) convertView
				.findViewById(R.id.statusTextView);

		exceptionTextView = (ImageView) convertView
				.findViewById(R.id.exceptionTextView);
		if (convertView == null) {
		...
		if (vo != null) {
			try {
				...
				// String[] sa = context.getResources().getStringArray(
				// R.array.fuzhe);
	...
	public void d(String title, String[] arrayFruit) {
		final AlertDialog builder = new AlertDialog.Builder(context)
				.setTitle(title).setMultiChoiceItems(arrayFruit, null, null)
	...
	public void hexingDialog_v2(final String title, String[] arrayFruit) {
		...
		fh.post(url, ap, new AjaxCallBack<Object>() {
			...
			public void onSuccess(Object t) {
				// TODO Auto-generated method stub
				String s = (String) t;
				JiancheResp resp = (JiancheResp) ReqJsonUtil.changeToObject(s,
						JiancheResp.class);
				if (resp != null) {
